...
export const ValidCtrl = (function () {
    ...
    const addValidacao = () => {
        ...
        let ensaioValidacao = new Validacao(id, ManipuladoUICtrl.UISelectors.ensaioValidacao.value, ManipuladoUICtrl.UISelectors.especificacaoValidacao.value, ManipuladoUICtrl.UISelectors.resultadoValidacao.value);
    ...
    const validateEnsaioValidacao = (ensaioValidacao) => {
        if (ensaioValidacao.id !== null && ensaioValidacao.nomeEnsaio && ensaioValidacao.especificacao && ensaioValidacao.resultado) {
            return true;
        } else {
            return false;
        }
